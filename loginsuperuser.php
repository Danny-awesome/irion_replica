...
<?php 
require_once 'scripts/admin_login.php'; 
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <nav class="navbar navbar-expand-md irionNavBar fixed-top navbar-default navbar-custom">
    ...
    <div class="row login-card">
        ...
        <div class="col-md-4 p-4">
           ...
           <form action="loginsuperuser.php" method="post" id="loginform">
                ...
                <div class="form-group d-flex justify-content-center">
                    <input type="text" id="login-email" placeholder="Admin" name="name" value="<?php echo $name ?>">
                </div>
                <div class="form-group d-flex justify-content-center ">
