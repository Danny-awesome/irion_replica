...
<!-- TERMS OF USE  -->
        <div class="row terms-notes">
            <div class="col-md-12 p-2">
                ...
                <p>
                    Irion (the “Company”) is committed to maintaining robust privacy protections for its users.
                Our Privacy Policy is designed to help you understand how we collect, use and safeguard
                the information you provide to us and to assist you in making informed decisions when
                using our Service.
                </p>
                ...
                <h6>The Service allows you to</h6>
                <h6 class="pl-3">REGISTRATION; RULES FOR USER CONDUCT AND USE OF THE SERVICE</h6>
                <p>
                    You need to be at least [18 years old] and a resident of the Federal Republic of Nigeria to
                ...
                <ul class="pl-4">
                    <li><span class="pr-2">- </span>access the Service for any reason other than your personal, commercial use solely as
                    permitted by the normal functionality of the Service</li>
                    <li><span class="pr-2">- </span>collect or harvest any personal data of any user of the Site or the Service</li>
                    <li><span class="pr-2">- </span>use the Site or the Service for the solicitation of business in the course of trade or in connection with a commercial enterprise;</li>
                    <li><span class="pr-2">- </span>distribute any part or parts of the Site or the Service without our explicit written permission (we grant the operators of public search engines permission to use spiders to copy materials from the site for the sole purpose of creating publicly-available searchable indices but retain the right to revoke this permission at any time on a general or specific basis);</li>
                    <li><span class="pr-2">- </span>use the Service for any unlawful purpose or for the promotion of illegal activities;</li>
                    <li><span class="pr-2">- </span>attempt to, or harass, abuse or harm another person or group;</li>
                    <li><span class="pr-2">- </span>intentionally allow another user to access your account;</li>
                    <li><span class="pr-2">- </span>provide false or inaccurate information when registering an account;</li>
                    <li><span class="pr-2">- </span>interfere or attempt to interfere with the proper functioning of the Service;</li>
                    <li><span class="pr-2">- </span>make any automated use of the Site, the Service or the related systems, or take any action
                    ...
                    <li><span class="pr-2">- </span>bypass any robot exclusion headers or other measures we take to restrict access to the
                    Service, or use any software, technology, or device to scrape, spider, or crawl the Service or
                    harvest or manipulate data;</li>
                    <li><span class="pr-2">- </span>circumvent, disable or otherwise interfere with any security-related features of the Service or
                    ...
                    <li><span class="pr-2">- </span>publish or link to malicious content of any sort, including that intended to damage or disrupt
                    another user’s browser or computer</li>
                 </ul>
                </p>
                <h6>POSTING AND CONDUCT RESTRICTIONS</h6>
                <p>When you create your own personalized account, you may be able to provide </p>
                <ul>
                    <li><span class="pr-2">- </span>Account Name</li>
                    <li><span class="pr-2">- </span>Account Number</li>
                    <li><span class="pr-2">- </span>Phone Number</li>
                    <li><span class="pr-2">- </span>Proof Of Payment</li>
                </ul>
                <p>
                You are solely responsible for the User Content that you post, upload, link to or otherwise make
...
conditions constitutes a material breach of these Terms.
                ...
                <ul>
                    <li><span class="pr-2">- </span>You are solely responsible for your account and the activity that occurs while signed in to or
while using your account;</li>
                    <li><span class="pr-2">- </span>You will not post information that is malicious, libelous, false or inaccurate;
</li>
                    <li><span class="pr-2">- </span>You will not post any information that is abusive, threatening, obscene, defamatory, libelous,
or racially, sexually, religiously, or otherwise objectionable and offensive;</li>
                    <li><span class="pr-2">- </span>You retain all ownership rights in your User Content but you are required to grant the
...
transferable license to use, distribute, prepare derivative works of, display, and perform that
Content in connection with the provision of the Service; and you grant to each user of the
Service, a worldwide, non-exclusive, royalty-free license to access your User Content through
the Service, and to use, distribute, display and perform such Content to the extent permitted by
the Service and under these Terms of Use;
</li>
                    <li><span class="pr-2">- </span>You will not submit content that is copyrighted or subject to third party proprietary rights,
...
and
                    ...
                    <li><span class="pr-2">- </span>You hereby agree that we have the right to determine whether your User Content
submissions are appropriate and comply with these Terms of Service, remove any and/or all of
your submissions, and terminate or suspend your account with or without prior notice.
</li>
                </ul>
                <p>
                ...
                <h6>ONLINE CONTENT DISCLAIMER</h6>
                <p>
...
entity or which we deem unlawful, offensive, abusive, harmful or malicious. [E-mails, meetings
and information sharing between you and other participants that are not readily accessible to
the general public won't be treated by us as such you are private to the extent required by 
applicable law.] The Company shall have the right to remove any material that in its sole
...
use may result in criminal and/or civil prosecution under Federal, State and local law. If you
become aware of a misuse of our Service or violation of these Terms of Use, please contact us.

          </p>
          <h6>LINKS TO OTHER SITES AND/OR MATERIALS</h6>
...
and data gathering practices, of any Third Party Site to which you navig
        </p>
        <h6>LICENSE GRANT</h6>
        <p>
...
transferable, perpetual, irrevocable, non-exclusive, worldwide license to use, modify, publish,
list information regarding, edit, translate, distribute, publicly perform, publicly display, of all
such User Content and your name, voice, and/or likeness as contained in your User Content, if
applicable, in whole or in part, and in any form, media or technology, whether now known or
...
and other proprietary rights. We reserve all rights that are not expressly granted to you under
these Terms of Use.

        </p>
        <h6>EMAIL MAY NOT BE USED TO PROVIDE NOTICE</h6>
        <p>
...
any situation where legal notice is required by contract or any law or regulation.
        ...
        <h6>USER CONSENT TO RECEIVE COMMUNICATIONS IN ELECTRONIC FORM</h6>
        <p>
...
account settings, using the “Unsubscribe” link in the message. Opting out may prevent you
...
WE DO NOT IN ANYWAY HOLD RESPONSIBILITY FOR ANY LOSS OF INCOME OR
FUNDS DUE TO DAMAGE, LOSS, MISUSE OF/TO THE SITE OR , NEGLEGIENCE OF
TERMS OF USE.

        </p>
        <h6>LIMITATION OF DAMAGES; RELEASE</h6>
        <p>
...
REMEDY SET FORTH HEREIN IS FOUND TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
        ...
        <h6>SOME JURISDICTIONS LIMIT OR DO NOT PERMIT DISCLAIMERS OF LIABILITY, SO THIS
        PROVISION MAY NOT APPLY TO YOU.
        </h6>
        <p>
        If you have a dispute with one or more users, using the Service, you release us (and our officers,
        ...
        <h6>MODIFICATION OF TERMS OF USE</h6>
        <p>
...
Company must commence within a QUATER of a year after the cause of action accrues.
Otherwise, such cause of action is permanently barred.

        </p>
        <p>
        These Terms of Use and your use of the Site are governed by the federal laws of the FEDERAL
REPUBLIC of NIGERIA without regard to conflict of law provisions.
        </p>
        <p>
...
PRIVACY POLICY AT [INSERT LINK TO PRIVACY POLICY] REPRESENT THE COMPLETE
...
accessed at [Company URL] .
“Service” refers to the Company’s services accessed via the Site, in which users can generate
income.
...
here: [insert link to Terms of Use]), and you consent to our collection, storage, use and
disclosure of your Personal Information as described in this Privacy Policy.

            
            <h6>INFORMATION WE COLLECT</h6>
           <p>
            We collect “Personal Information.” Personal Information includes your email [ date of birth,
contact information, Account details], which you submit to us through the registration process
at the Site.

            </p>
            <h6>Information you provide us by registering for an account</h6>
            <p>
...
knowingly collect or solicit information from anyone under the age of 18, or allow anyone
under the age of 18 to sign up for the Service. In the event that we learn that we have
gathered personal information from anyone under the age of 18 without the consent of a
...
or the public as required or permitted by law.
            ...
            <p>We implement security measures designed to protect your information from unauthorized
...
firewalls and secure server software. By using</p>
              <h6>YOUR RIGHTS REGARDING THE USE OF YOUR PERSONAL INFORMATION</h6>
              <p>You have the right at any time to prevent us from contacting you for marketing purposes.
...
communications from us in the [list location of opt-out page, i.e. “Settings” section] of the
Site. Please note that notwithstanding the promotional preferences you indicate by either
unsubscribing or opting out in the [location of opt-out page] of the Site, we may continue to
send you administrative emails including, for example, periodic updates to our Privacy
Policy.
</p>
<h6> LINKS TO OTHER WEBSITES

</h6>
        <p>As part of the Service, we may provide links to or compatibility with other websites or
applications. However, we are not responsible for the privacy practices employed by those
websites or the information or content they contain. This Privacy Policy applies solely to information collected by us through the Site and the Service. Therefore, this Privacy Policy
...
and this privacy page for updates.
        ...
        <h6>CONTACT US</h6>
        <p>If you have any questions regarding this Privacy Policy or the practices of this Site, please
contact us by sending an email.
Last Updated: This Privacy Policy was last updated on [1st November 2019].</p>
        </div>
    </body>
</html>